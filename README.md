...
Login/Password: admin/(empty password) or user/user(passwword is changed there admin panel)
...
* English, Deutsch, French, Chinese, Spanish
...
test-vpn
````
See OpenVPN-WEbAdmin in browser: http://localhost:8061/
!!Openvpn not tested
