...
Das ist eine frühe Version und noch nicht ganz fertig.

Das Grundsystem passt so weit, das Setup ist getestet mit nginx und externem SQL-Server.
...
![GitHub OpenVPN-WebAdmin commits since latest release](https://img.shields.io/github/commits-since/Wutze/OpenVPN-WebAdmin/2.0.0?style=plastic)
![OpenVPN-WebAdmin Stable Branch](https://img.shields.io/badge/Main-Stable%20Branch-green)
